...
public class ÖvnUppg4_DatabasFacit {
    ...
    public int getAmountOfQuestionsForACertainCategory(Category category){
        return (int) questions.stream()
                .filter(c -> c.category.equals(category)).count();
    }
    ...
    //Skapa en Map där kategorierna är nycklar och värdena är en lista av de frågesträngar som tillhör varje kategori
