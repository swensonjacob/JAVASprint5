...
public class PredicateExample { 
    ...
    { 
        ...
        Predicate<Integer> missionImpossible = lesserthan18.and(morethan18);
        Predicate<Integer> almostAlwaysTrue = lesserthan18.or(morethan18);
        System.out.println(missionImpossible.test(18));
